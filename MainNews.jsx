...
const MainNews = () => {
    ...
    //random articles (underneath the main article + related)
    const randomArticles =[
        {
            title: "Excepteur sint occaecat cupidatat non proident sunt in culpa",
            img: "https://placehold.co/600x400/eeeeee/999999?text=Article+1"
        },
        {
            title: "Sed ut perspiciatis unde omnis iste natus error sit voluptatem",
            img: "https://placehold.co/600x400/eeeeee/999999?text=Article+2"
        },
        {
            title: "Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut",
            img: "https://placehold.co/600x400/eeeeee/999999?text=Article+3"
        },
        {
            title: "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet",
            img: "https://placehold.co/600x400/eeeeee/999999?text=Article+4"
        }
    ];
    ...
    const latestHeadlines =[
        ...
        {
            title: "Blanditiis praesentium voluptatum deleniti atque corrupti quos ",
            time: "58 minutes ago"
        },
        {
            title: "Et harum quidem rerum facilis est et expedita distinctio nam libero ",
            time: "2 hours ago"
        },
        {
    ...
    return (
        <section className="mt-3 mb-5" aria-label="Main News Section">
            <div className="row">
                ...
                {/* LEFT CONTENT AREA (Main Article + Related Articles + 4 Random Articles) */}
                <div className="col-12 col-lg-8 pe-lg-4 mb-2 mb-lg-0">

                    {/* MAIN ARTICLE: SIDE-BY-SIDE LAYOUT (4-column and 2-column views) */}
                    ...
                    {/* MAIN ARTICLE: STACKED LAYOUT (3-column, 4-column shrunk and 1-column views) */}
                    ...
                    <div className="row">
                        {randomArticles.map((art, i) => (
                            /*
                                ...
                                col-xl-12: Shrunk Desktop (1 col list - overrides to Title Left/Image Right)
                    ...
                    {/* Desktop Most Popular (3-column layout) */}
                ...
                {/* it sits on the right for 3 and 4 column views; it drops below the articles for 1 and 2 column views */}
