...
const PhotosSection = () => {
    ...
    const mainPhoto = {
        ...
        desc: "Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit. Lorem ipsum dolor sit amet."
    };
    ...
    return (
        <section className="photos-section mt-5" aria-label="Photos Section">
            ...
            <div className="row">
                {/* Main Photo Column */}
                {/* col-xl-7 takes ~60% width on 4-col view. col-12 takes 100% on 3, 2, and 1-col views */}
                <div className="col-12 col-xl-7 mb-4 mb-xl-0">
                    ...
                    {/* Description is hidden on 2-col (md) and 1-col (sm/xs) views, visible on 3-col (lg) and 4-col (xl) */}
                ...
                <div className="col-12 col-xl-5">
                    <div className="row">
                        {sidePhotos.map((title, idx) => (
                            /* 
                                col-12: 1-col view (xs/sm) & 4-col view (xl/xxl sidebar list)
                                col-md-6, col-lg-6: 2-col x 3-row grid view (md/lg)
                            */
            ...
            {isExpanded && (
                <div className="row mt-4">
                    {extraPhotos.map((title, idx) => (
                        /* 
                            col-6: 3x2 Grid on 1-col/2-col views (xs, sm, md)
                            col-lg-4: 2x3 Grid on 3-col view (lg)
                            col-xl-3: 2x4 Grid on 4-col view (xl/xxl)
                        */
